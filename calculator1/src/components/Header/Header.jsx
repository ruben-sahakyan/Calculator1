...
export default () => {
    ...
    const handleCalculate = (ev) => {
        ...
        if(width.trim() === '') {
            ...
            // listBoard.sort((a, b) => b.containerWidth * b.containerHeight - a.containerWidth * a.containerHeight);
            listBoard.sort((a, b) => b.containerWidth - a.containerWidth);
            setDataField([...listBoard]);
        }
    }
    return (
        <>
            ...
            <form onSubmit={handleCalculate}>
                <div className="width-section">
                    ...
                    <div className="width-input">
                        ...
                        <input type="number" min="0" max="3630" placeholder="Width" onChange={ev => {setWidth(ev.target.value)}} value={width}/>
                    </div>
                </div>
                <div className="height-section">
                    ...
                    <div className="height-input">
                        ...
                        <input type="number" min="0" max="1830" placeholder="Height" onChange={ev => {setHeight(ev.target.value)}} value={height}/>
                    </div>
                </div>
                <div className="quantity-section">
                    ...
                    <div className="quantity-input">
                        ...
                        <input type="number" placeholder="Quantity" onChange={ev => {setQuantity(ev.target.value)}} value={quantity}/>
                    </div>
                </div>
